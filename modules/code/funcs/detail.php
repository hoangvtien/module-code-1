...
$result = $db->query('SELECT id, title, alias, image FROM ' . NV_PREFIXLANG . '_' . $module_data . ' WHERE catid=' . $array_data['catid'] . ' AND id != ' . $array_data['id'] . ' ORDER BY id DESC LIMIT 9');
