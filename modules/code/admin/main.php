 ...
 * @Createdate Tue, 14 Jul 2015 04:18:04 GMT
 */
...
if ($show_view) {
    ...
    while ($view = $sth->fetch()) {
        ...
        $view['link_view'] = NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $module_name . '/' . $view['alias'] . '-' . $view['id'];
